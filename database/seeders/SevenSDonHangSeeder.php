    ...
    public function run(): void
    {
        $items = [
            ...
            [
                'section'    => 'S6&S7 — An toàn & Tiết kiệm',
                'sort_order' => 12,
                'content'    => 'Tạo lệnh in trên máy in rất nhiều nhưng không in ra để sử dụng dẫn đến quá tải',
            ],
        ];

        foreach ($items as $item) {
            SevenSChecklist::firstOrCreate(
                ['department' => 'Đơn hàng', 'section' => $item['section'], 'sort_order' => $item['sort_order']],
