...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        $this->call([
            ...
            SevenSKhoThanhPhamSeeder::class,
            ...
            SevenSXuong6Tang1Seeder::class,
            SevenSXuong6Tang2Seeder::class,
            SevenSMayXuong6Tang1Seeder::class,
            SevenSMayXuong6Tang2Seeder::class,
            SevenSLaKTHTDongGoiTang1Seeder::class,
            SevenSLaKTHTDongGoiTang2Seeder::class,
            SevenSQAKTDCFQCSeeder::class,
