...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-8">
        ...
        <div class="row row-cols-2 row-cols-md-3 g-3">
            ...
            @if(\App\Support\FeatureAccess::allows($currentUser, 'candidates.create'))
            <div class="col">
            ...
            @if(\App\Support\FeatureAccess::allows($currentUser, 'visitors.create') || \App\Support\FeatureAccess::allows($currentUser, 'visitors.security'))
            <div class="col">
                <a href="{{ route('visitor-tickets.index') }}" class="btn btn-white border w-100 py-4 rounded-4 shadow-sm fw-semibold d-flex flex-column align-items-center justify-content-center h-100 tap hover-shadow transition">
                    <div class="p-3 rounded-circle mb-3" style="background:rgba(79,70,229,.1);color:#4f46e5;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
                            <circle cx="9" cy="7" r="4"/>
                            <path d="M23 21v-2a4 4 0 0 0-3-3.87"/>
