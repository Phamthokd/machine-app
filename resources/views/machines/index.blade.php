                    ...
                    <tr>
                        ...
                        <td class="px-2 text-center">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <form action="{{ route('machines.destroy', $m->id) }}" method="POST" onsubmit="return confirm('{{ __('messages.delete_machine_confirm') }}');" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-outline-danger border-0 p-1" title="{{ __('messages.delete_btn') }}">
