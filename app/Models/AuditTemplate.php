...
class AuditTemplate extends Model
{
    ...
    public static function normalizeDepartmentName(?string $departmentName): ?string
    {
        ...
        $map = [
            ...
            'may xÆ°á»Ÿng 6 táº§ng 1' => 'May xưởng 6 tầng 1',
            'may xưởng 6 tầng 1' => 'May xưởng 6 tầng 1',
            'may xÆ°á»Ÿng 6 táº§ng 2' => 'May xưởng 6 tầng 2',
            'may xưởng 6 tầng 2' => 'May xưởng 6 tầng 2',
            'lÃ , ktht, Ä‘Ã³ng gÃ³i táº§ng 1' => 'Là, KTHT, đóng gói tầng 1',
            'là, ktht, đóng gói tầng 1' => 'Là, KTHT, đóng gói tầng 1',
            'lÃ , ktht, Ä‘Ã³ng gÃ³i táº§ng 2' => 'Là, KTHT, đóng gói tầng 2',
            'là, ktht, đóng gói tầng 2' => 'Là, KTHT, đóng gói tầng 2',
            'qa, ktdc, fqc' => 'QA, KTDC, FQC',
