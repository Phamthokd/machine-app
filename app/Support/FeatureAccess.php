...
class FeatureAccess
{
    public static function allows(?User $user, string $feature): bool
    {
        ...
        return match ($feature) {
            ...
            'repairs.manage' => $user->hasAnyRole(['admin', 'warehouse', 'repair_tech', 'contractor', 'team_leader', 'supervisor', 'senior_manager']) || $user->can('repairs.manage'),
            'repairs.view' => $user->hasAnyRole(['admin', 'warehouse', 'repair_tech', 'contractor', 'team_leader', 'audit', '7s', 'supervisor', 'senior_manager']) || $user->can('repairs.view'),
